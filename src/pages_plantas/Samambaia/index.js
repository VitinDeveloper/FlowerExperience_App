        ...
        <View style={styles.HeaderBody}>
          ...
          <View style={styles.HeaderBodyEsquerda}>
            ...
            <View style={styles.HeaderBodyImagemUm}>
              ...
              <View style={styles.imagemUm}>
                <Image
                  source={require('./../../../src/plantas/SAMAMBAIA1.png')}
            ...
            <View style={styles.HeaderBodyTituloPlanta}>
              <Text style={{ fontSize: 32, fontWeight: 'bold', color: '#8b8a7a' }}>Samambaia</Text>
            </View>
          ...
          <View style={styles.HeaderBodyDireita}>
            ...
            <View style={styles.imagemDois}>
              <Image
                source={require('./../../../src/plantas/SAMAMBAIA2.png')}
                style={{ width: '100%', height: '100%', borderRadius: 17, }}
              />
            </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              Uma boa iluminação é essencial para que a samambaia cresça saudável. O recomendado é cultivá-la em locais à meia sombra. 
              Assim ela poderá receber a energia dos raios do sol sem correr o risco de queimar suas folhas. 
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              A samambaia é uma espécie que precisa do solo sempre úmido para absorver os nutrientes. Por isso, o recomendado é fazer a rega da planta diariamente, 
              a menos que o amante de jardinagem perceba que a terra está próxima de ficar encharcada.
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              Além de um solo úmido, as samambaias precisam que o substrato seja rico em material orgânico e nutrientes.
               A melhor opção é adquirir produtos que contenham fibra de coco na fórmula, pois ajuda a deixar o terreno mais drenável. 
              </Text>
            </Text>
          </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              Tem sua origem na Oceania, com ocorrência na Ásia, Austrália e Madagascar.
              </Text>
            </Text>
          </View>
        </View>
