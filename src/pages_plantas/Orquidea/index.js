        ...
        <View style={styles.HeaderBody}>
          ...
          <View style={styles.HeaderBodyEsquerda}>
            ...
            <View style={styles.HeaderBodyImagemUm}>
              ...
              <View style={styles.imagemUm}>
                <Image
                  source={require('./../../../src/plantas/ORQUIDEA1.png')}
            ...
            <View style={styles.HeaderBodyTituloPlanta}>
              <Text style={{ fontSize: 32, fontWeight: 'bold', color: '#8b8a7a' }}>Orquídea</Text>
            </View>
          ...
          <View style={styles.HeaderBodyDireita}>
            ...
            <View style={styles.imagemDois}>
              <Image
                source={require('./../../../src/plantas/ORQUIDEA2.png')}
                style={{ width: '100%', height: '100%', borderRadius: 17, }}
              />
            </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              É importante que ela receba sua dose diária. No entanto, não se deve colocar os vasos em lugares onde o sol é direto. 
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              O excesso de água pode ser mortal. Tente regar as orquídeas apenas uma vez por semana. 
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              A melhor forma de aplicar o adubo líquido é juntando-o à água de rega. Podemos fertilizar, 
              nas doses indicadas na embalagem, duas vezes por mês, ou colocar sempre fertilizante em todas as regas.
              </Text>
            </Text>
          </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              A orquídea é originária do continente americano, no entanto, foi levada para a Europa no século XVIII por barcos da Marinha britânica.
              </Text>
            </Text>
          </View>
        </View>
