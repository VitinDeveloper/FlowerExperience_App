        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              A espada de São Jorge é uma planta bastante resistente e que sobrevive em áreas externas com sol e também em áreas internas com menos incidência de luz e vento. 
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              Basicamente, para saber como cuidar de uma espada de São Jorge, basta regar de uma a duas vezes por semana.
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              A adubação deve ser feita uma vez ao ano para a reposição dos nutrientes.
              </Text>
            </Text>
          </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              As espadas de São Jorge são originárias da África.
              </Text>
            </Text>
          </View>
        </View>
