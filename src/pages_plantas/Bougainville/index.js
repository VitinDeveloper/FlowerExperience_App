        ...
        <View style={styles.HeaderBody}>
          ...
          <View style={styles.HeaderBodyEsquerda}>
            ...
            <View style={styles.HeaderBodyImagemUm}>
              ...
              <View style={styles.imagemUm}>
                <Image
                  source={require('./../../../src/plantas/BOUGANVILLE1.png')}
            ...
            <View style={styles.HeaderBodyTituloPlanta}>
              <Text style={{ fontSize: 32, fontWeight: 'bold', color: '#8b8a7a' }}>Bougainville</Text>
            </View>
          ...
          <View style={styles.HeaderBodyDireita}>
            ...
            <View style={styles.imagemDois}>
              <Image
                source={require('./../../../src/plantas/BOUGANVILLE2.png')}
                style={{ width: '100%', height: '100%', borderRadius: 17, }}
              />
            </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              Essa planta precisa de lugares com bastante sol. Ou seja, independentemente do local que você escolher, é importante que a espécie receba bastante iluminação.
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              A bougainville não gosta de água em excesso, especialmente na raiz. Por isso, o ideal é usar um regador para ter um controle maior da quantidade colocada no vaso ou no solo.
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              Essa é uma planta que deve ser adubada utilizando fertilizantes NPK 4-14-8. Aplicar o adubo de 6 em 6 meses é o bastante para estimular a floração da bougainville.
              </Text>
            </Text>
          </View>
