        ...
        <View style={styles.HeaderBody}>
          ...
          <View style={styles.HeaderBodyDireita}>
            ...
            <View style={styles.imagemDois}>
              <Image
                source={require('./../../../src/plantas/ESPADA2.png')}
                style={{ width: '100%', height: '100%', borderRadius: 17, }}
              />
            </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              A flor dipladênia precisa receber bastante luz indireta, pois os raios diretos podem queimar na superfície. 
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              No verão, quando a terra seca mais rápido, é importante regar a planta dipladênia pelo menos 3 vezes por semana. Nas outras estações você pode intercalar a rega de 7 a 10 dias.
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              O melhor substrato para usar na dipladênia em vaso é a combinação de turfa preta, que é um material fóssil originado da decomposição de restos vegetais com fibra de coco ou areia de rio, divididos em partes iguais.
              </Text>
            </Text>
          </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              Originária das regiões tropicais e subtropicais da América do Sul.
              </Text>
            </Text>
          </View>
        </View>
