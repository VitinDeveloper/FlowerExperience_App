        ...
        <View style={styles.HeaderBody}>
          ...
          <View style={styles.HeaderBodyEsquerda}>
            ...
            <View style={styles.HeaderBodyTituloPlanta}>
              <Text style={{ fontSize: 32, fontWeight: 'bold', color: '#8b8a7a' }}>Peperomia</Text>
            </View>
          ...
          <View style={styles.HeaderBodyDireita}>
            ...
            <View style={styles.imagemDois}>
              <Image
                source={require('./../../../src/plantas/PEPEROMIA2.png')}
                style={{ width: '100%', height: '100%', borderRadius: 17, }}
              />
            </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              A peperômia é considerada uma planta de meia-luz, ou seja, um pouco de luz é sempre bem-vindo, mas exagerar não. 
              Evite colocá-las em um lugar na casa em que o sol bate a maior parte do dia. 
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              Por ser uma planta facilmente adaptável ao ambiente, os cuidados não são os mais difíceis: regá-las três vezes por semana já é o bastante. 
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              Quanto à manutenção, faça adubações a cada três meses. Recomendamos fertilizantes orgânicos, 
              que é granulado, de liberação lenta, nutre a planta, age por mais tempo e facilita o enraizamento.
              </Text>
            </Text>
          </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              Originária das regiões sul americanos, especificamente no Brasil.
              </Text>
            </Text>
          </View>
        </View>
