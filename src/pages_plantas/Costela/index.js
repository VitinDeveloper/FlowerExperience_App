        ...
        <View style={styles.HeaderBody}>
          ...
          <View style={styles.HeaderBodyEsquerda}>
            ...
            <View style={styles.HeaderBodyImagemUm}>
              ...
              <View style={styles.imagemUm}>
                <Image
                  source={require('./../../../src/plantas/COSTELA1.png')}
            ...
            <View style={styles.HeaderBodyTituloPlanta}>
              <Text style={{ fontSize: 32, fontWeight: 'bold', color: '#8b8a7a' }}>Costela-de-Adão</Text>
            </View>
          ...
          <View style={styles.HeaderBodyDireita}>
            ...
            <View style={styles.imagemDois}>
              <Image
                source={require('./../../../src/plantas/COSTELA2.png')}
                style={{ width: '100%', height: '100%', borderRadius: 17, }}
              />
            </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              A espécie, por ser adaptável, pode ser cultivada em diferentes espaços. Porém, como gosta de luz, o 
              local escolhido precisa ter claridade. Espaços com meia sombra e iluminação indireta são uma boa opção.
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              Regue a sua muda duas vezes na semana por conta das folhas mais largas, ela tem mais espaço para a evaporação da água.
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              A Costela-de-Adão precisa de um substrato fresco e com boa drenagem para se desenvolver. A troca de vaso todo ano é recomendada, 
              uma vez que ajuda a prolongar a vida da muda. Já o tamanho do recipiente deve ser levemente maior que a planta.
              </Text>
            </Text>
          </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              Nativo do sudeste e nordeste brasileiro, além da Bolívia, Peru e Argentina.
              </Text>
            </Text>
          </View>
        </View>
