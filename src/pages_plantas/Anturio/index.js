        ...
        <View style={styles.HeaderBody}>
          ...
          <View style={styles.HeaderBodyEsquerda}>
            ...
            <View style={styles.HeaderBodyImagemUm}>
              ...
              <View style={styles.imagemUm}>
                <Image
                  source={require('./../../../src/plantas/ANTURIO1.png')}
            ...
            <View style={styles.HeaderBodyTituloPlanta}>
              <Text style={{ fontSize: 32, fontWeight: 'bold', color: '#8b8a7a' }}>Antúrio</Text>
            </View>
          ...
          <View style={styles.HeaderBodyDireita}>
            ...
            <View style={styles.imagemDois}>
              <Image
                source={require('./../../../src/plantas/ANTURIO2.png')}
                style={{ width: '100%', height: '100%', borderRadius: 17, }}
              />
            </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              Esta é uma planta de meia-sombra. Ou seja, sol em excesso pode prejudicá-la, já que prefere áreas com luz indireta.
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              Por ser uma planta tropical, o antúrio gosta de muita umidade! Por isso, a rega deve ocorrer com frequência: 
              três vezes por semana durante as estações mais quentes e duas em períodos mais frios.
              </Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              Geralmente, a planta já é comercializada com o substrato ideal. Mantenha a nutrição da terra utilizando
              fertilizantes a cada três meses e sua planta ficará bela e saudável!
              </Text>
            </Text>
          </View>
        ...
        <View style={styles.DivInforma}>
          ...
          <View style={styles.InformaTextoDiv}>
            <Text>
              ...
              <Text style={styles.TextoDescricao}>
              A origem dos Antúrios é a América Central e do Sul.
              </Text>
            </Text>
          </View>
        </View>
